...
const getSubjectFromPass = (pass) => {
  ...
  if (p.startsWith('SI')) return { id: 'sin', name: 'Sinh học', color: 'bg-purple-100 text-purple-700 border-purple-200' };
  ...
  if (p.startsWith('DI')) return { id: 'di', name: 'Địa lý', color: 'bg-green-100 text-green-700 border-green-200' }; 
