...
const ExamPortal: React.FC<ExamPortalProps> = ({ grade: rawGrade, onBack, onStart }) => {
  ...
  className="w-full p-4 rounded-xl border font-black uppercase"
>
  ...
  <option value="KT">KTPL</option>
  <option value="CN">CNCN</option>
  <option value="NN">CNNN</option>
  <option value="TT">Chung</option>
